...
## push
> 도커 레지스트리에 이미지를 올리는 명령
```
docker push <저장소 이름>/<이미지 이름>:<태그>

# 개인 저장소에 이미지 올리기.
docker tag hello:0.1 192.168.0.11:5000/hello:0.1
docker pull 192.168.0.11:5000/hello:0.1
```
...
```
* -t, --time=10 : 컨테이너를 정지하기 전에 대기하는 시간을 설정. 
